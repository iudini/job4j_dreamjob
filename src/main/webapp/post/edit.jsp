            ...
            <div class="card-body">
                <form action="<%=request.getContextPath()%>/posts.do?id=<%=post.getId()%>" method="post">
                    <div class="form-group">
                        <label>Имя</label>
                        <input type="text" class="form-control" id="name" name="name" value="<%=post.getName()%>" title="Заполните имя">
                        <label>Описание</label>
                        <input type="text" class="form-control" id="desc" name="description" value="<%=post.getDescription()%>" title="Заполните описание">
                    </div>
